...
<div class="step done">
<div class="step-badge"><i class="icon-ok"></i></div>
<a href="checkout-step-2.php">Shipping Address</a>
</div>
<div class="step done">
<div class="step-badge"><i class="icon-ok"></i></div>
<a href="checkout-step-3.php">Payment Method</a>
</div>
...
<p class="right-align">
<a href="index.php" class="btn btn-primary higher bold">CONFIRM &amp; PAY</a>
</p>
</div>
</div>
</div>
